#!/usr/bin/env python3
import experiments.load_test.load_test_chaos.experiment.load_test_chaos as load_test_chaos
...
def main():
	...
	elif args.name == "load-test-chaos":
		load_test_chaos.Experiment(clients)
	else:
